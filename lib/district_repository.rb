...
class DistrictRepository
  ...
  def self.from_csv(data_dir)
    data_hash = {}
    Parse.parse_data_type_1(data_dir, data_hash, 'Pupil enrollment.csv')
    Parse.parse_data_type_1(data_dir, data_hash, 'Online pupil enrollment.csv')
    Parse.parse_data_type_1(data_dir, data_hash, 'High school graduation rates.csv')
    Parse.parse_data_type_1(data_dir, data_hash, 'Kindergartners in full-day program.csv')
    Parse.parse_data_type_1(data_dir, data_hash, 'Median household income.csv')
    Parse.parse_data_type_1(data_dir, data_hash, 'Remediation in higher education.csv')
    Parse.parse_data_type_1(data_dir, data_hash, 'Title I students.csv')
